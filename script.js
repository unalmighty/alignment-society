...
// Interactive widgets (thermometer, impact generator, bingo)
document.addEventListener('DOMContentLoaded', () => {
  // Thermometer + Impactful Statement generator
  ...
  render();
  // Impactful statement generator arrays
  ...
  function gen(){
    const out = document.getElementById('impactOut');
    if(out){
      out.value = sentence();
      out.focus();
      out.select?.();
  ...
  if(bingo){
    // Clear any existing tiles (in case of hot reload)
    bingo.innerHTML = '';
